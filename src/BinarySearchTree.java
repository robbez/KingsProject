...
public class BinarySearchTree<E> extends AbstractSet<E> {
    ...
    protected class TreeIterator implements Iterator<E> {
         ...
         * TreeIterator objects next() method. The worstTime(n) is O(n) and
         * averageTime(n) is constant.
         *
         * @throws IllegalStateException - if this TreeIterators next() method
         * was not called before this call, or if this TreeIterators remove()
